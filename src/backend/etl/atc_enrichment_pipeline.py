...
try:
    ...
    from .atc_enrichment_reports import build_enrichment_report, write_enrichment_reports
    ...
    from src.backend.etl.atc_enrichment_reports import build_enrichment_report, write_enrichment_reports
...
class ATCEnrichmentPipeline:
    ...
    def _build_report(
        ...
        return build_enrichment_report(
            drugs_file=self.drugs_file,
            cache_dir=self.cache_dir,
            max_network_concurrency=self.max_network_concurrency,
            network_cache_hits=self.network_cache_hits,
            network_cache_misses=self.network_cache_misses,
            original_drugs=original_drugs,
            updated_drugs=updated_drugs,
            processed_drugs=processed_drugs,
            outcomes=outcomes,
            unresolved=unresolved,
    ...
    def _write_reports(
        ...
        write_enrichment_reports(self.reports_dir, report, unresolved)
